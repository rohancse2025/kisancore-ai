...
from app.api.routes import health, sensor, crop, irrigation, chat, weather, crops_ai, market, iot, auth, sms
...
api_router.include_router(sms.router, tags=["sms"], prefix="/sms")
